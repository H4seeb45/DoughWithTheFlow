...
export default function Features() {
  return (
    <section className="mt-10 px-4 mx-auto max-w-7xl">
      <h2 className="mb-1 text-3xl leading-tight text-white">Features</h2>
      <p className="mb-16 text-lg text-gray-500">
        Get insights to dig down into what's powering your growth the most.
      </p>
      <span className="fbar"></span>
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-16 lg:gap-x-24 gap-y-20">
        <div>
          ...
          <h3 className="mb-2 text-base leading-tight text-white">
            Personal Emails
          </h3>
        ...
        <div>
          ...
          <h3 className="mb-2 text-base leading-tight text-white">Clickable</h3>
          <p className="text-sm text-gray-500">
        ...
        <div>
          ...
          <h3 className="mb-2 text-base leading-tight text-white">Puzzles</h3>
          <p className="text-sm text-gray-500">
        ...
        <div>
          ...
          <h3 className="mb-2 text-base leading-tight text-white">Sparkles</h3>
          <p className="text-sm text-gray-500">
        ...
        <div>
          ...
          <h3 className="mb-2 text-base leading-tight text-white">Stars</h3>
          <p className="text-sm text-gray-500">
        ...
        <div>
          ...
          <h3 className="mb-2 text-base leading-tight text-white">Support</h3>
          <p className="text-sm text-gray-500">
